__all__ = ["dataset_mean", "dataset_size", "dataset_std", "get_dataset"]
...
from .transforms import Cast, GreyToColor, Normalize, Rescale, Reshape
    ...
    if name == mnist:
        if "transform" not in kwargs:
            transform = [
                Cast(10),
                Rescale(255),
                Reshape(dataset_size[digits][:-1]),
                GreyToColor(),
                Normalize(dataset_mean[digits], dataset_std[digits]),
            ]
